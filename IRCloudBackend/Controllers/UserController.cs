...
namespace IRCloudBackend.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserDTO>> GetUserProfile(string username)
        {
            ...
            var domainUser = await _context.DomainUsers.FirstOrDefaultAsync(user => user.ApplicationUserGuid == applicationUser.Id);
        ...
        public async Task<IActionResult> PatchUserProfile(UpdateUserProfileRequest request)
        {
            ...
            var currentUser = await _context.DomainUsers.FirstOrDefaultAsync(u => u.ApplicationUserGuid == userId);
            if (currentUser == null)
            {
                return BadRequest();
            }
